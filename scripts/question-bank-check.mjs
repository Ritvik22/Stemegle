...
for (const question of QUESTION_BANK) {
  ...
  if (new Set(question.choices).size !== 4) throw new Error(`Expected unique choices: ${question.q}`);
...
if (QUESTION_BANK.length < 5624) throw new Error(`Expected 5624+ questions, found ${QUESTION_BANK.length}`);
